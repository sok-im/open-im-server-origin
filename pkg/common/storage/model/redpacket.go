...
type RedPacket struct {
	...
	ClaimedAmountDisplay   string    `bson:"claimed_amount_display"`
	ClaimedShares          int32     `bson:"claimed_shares"`
	RemainingAmount        string    `bson:"remaining_amount"`
	RemainingAmountDisplay string    `bson:"remaining_amount_display"`
	RemainingShares        int32     `bson:"remaining_shares"`
