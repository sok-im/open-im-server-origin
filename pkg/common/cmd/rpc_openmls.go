...
import (
	...
	"github.com/openimsdk/open-im-server/v3/internal/rpc/openmls"
...
func NewOpenMLSRpcCmd() *OpenMLSRpcCmd {
	var cfg openmls.Config
	ret := &OpenMLSRpcCmd{cfg: &cfg}
	ret.configMap = map[string]any{
		OpenIMRPCOpenMLSCfgFileName: &cfg.RpcConfig,
...
func (c *OpenMLSRpcCmd) Exec() error {
	return c.Execute()
}

func (c *OpenMLSRpcCmd) runE() error {
	return startrpc.Start(c.ctx,
		...
		c.Index(),
		c.cfg.Share.RpcRegisterName.OpenMLS,
		&c.cfg.Share,
		c.cfg,
		nil,
		openmls.Start,
