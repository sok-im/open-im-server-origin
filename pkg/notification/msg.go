...
func newContentTypeConf(conf *config.Notification) map[int32]config.NotificationConfig {
	return map[int32]config.NotificationConfig{
		...
		constant.GroupCallParticipantCountUpdatedNotification: conf.GroupCallParticipantCountUpdated,
		constant.GroupCallParticipantDeclinedNotification:     conf.GroupCallParticipantDeclined,
...
func newSessionTypeConf() map[int32]int32 {
	return map[int32]int32{
		...
		constant.GroupCallParticipantCountUpdatedNotification: constant.ReadGroupChatType,
		constant.GroupCallParticipantDeclinedNotification:     constant.ReadGroupChatType,
